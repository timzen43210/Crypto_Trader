...
BASE_CONFIG = dict(
    ...
    RESOLVE_SAME_BAR_WITH_5M=True, RESOLVE_INTERVALS=["1M", "5M", "15M"],
...
BOOKS = {
    ...
    "watch": {"label": "觀察組（ATR ≥ 2%，供區間監控）", "overrides": {"ATR_MIN_PCT": 0.02, "ATR_MAX_PCT": None}},
}
